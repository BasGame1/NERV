...
if echo "Screen resolution 2340x1080 detected for $TARGET_CODENAME"; then
    cp -a --preserve=all "$SRC_DIR/unica/mods/bootanim/2340x1080/"* "$WORK_DIR/system/system/media"
elif echo "Screen resolution 2400x1080 detected for $TARGET_CODENAME"; then
    cp -a --preserve=all "$SRC_DIR/unica/mods/bootanim/2400x1080/"* "$WORK_DIR/system/system/media"
elif echo "Screen resolution 1280x720 detected for $TARGET_CODENAME"; then cp -a --preserve=all "$SRC_DIR/unica/mods/bootanim/1280x720/"* "$WORK_DIR/system/system/media"
else
